...
import UpdatePetManyPhotosByIdUseCase from './usecases/update.pet.many.photos.usecase';
...
@Module({
  ...
  providers: [
    ...
    {
      provide: PetTokens.updatePetManyPhotosByIdUseCase,
      useClass: UpdatePetManyPhotosByIdUseCase,
    },
    {
